...
function setDinoLose() {
  dino.src = "/dino/assets/dino-lose.png";
}

function handleRun(delta, speedScale) {
  if (isJumping) {
    dino.src = `/dino/assets/dino-stationary.png`;
    return;
  }

  if (currentFrameTime >= FRAME_TIME) {
    dinoFrame = (dinoFrame + 1) % DINO_FRAME_COUNT;
    dino.src = `/dino/assets/dino-run-${dinoFrame}.png`; /* switch between images to simulate movement */
...
function createCactus() {
  ...
  cactus.src = "/dino/assets/cactus.png";
